...
@Composable
fun TheMovieNavGraph(
    modifier: Modifier = Modifier,
    navController: NavHostController = rememberNavController(),
    coroutineScope: CoroutineScope = rememberCoroutineScope(),
    drawerState: DrawerState = rememberDrawerState(initialValue = DrawerValue.Closed),
    startDestination: String = TheMovieDestinations.TASKS_ROUTE,
    navActions: TheMovieNavigationActions = remember(navController) {
        TheMovieNavigationActions(navController)
    }
) {
    ...
    NavHost(
        ...
        composable(
            TheMovieDestinations.TASKS_ROUTE,
            arguments = listOf(

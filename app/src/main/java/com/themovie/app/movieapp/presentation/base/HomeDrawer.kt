...
fun AppModalDrawer(
    ...
    currentRoute: String,
    navigationActions: TheMovieNavigationActions,
...
private fun AppDrawer(
    ...
    Column(modifier = modifier.fillMaxSize()) {
        ...
        DrawerButton(
            ...
            isSelected = currentRoute == TheMovieDestinations.TASKS_ROUTE,
            action = {
                navigateToTasks()
                closeDrawer()
            }
        ...
        DrawerButton(
            ...
            isSelected = currentRoute == TheMovieDestinations.STATISTICS_ROUTE,
            action = {
...
fun PreviewAppDrawer() {
    AppCompatTheme {
        Surface {
            AppDrawer(
                currentRoute = TheMovieDestinations.TASKS_ROUTE,
                navigateToTasks = {},
                navigateToStatistics = {},
                closeDrawer = {}
            )

...
import com.themovie.app.movieapp.TheMovieScreens.ADD_EDIT_TASK_SCREEN
import com.themovie.app.movieapp.TheMovieScreens.STATISTICS_SCREEN
import com.themovie.app.movieapp.TheMovieScreens.TASKS_SCREEN
import com.themovie.app.movieapp.TheMovieScreens.TASK_DETAIL_SCREEN

/**
 * Screens used in [TheMovieDestinations]
 */
private object TheMovieScreens {
...
/**
 * Arguments used in [TheMovieDestinations] routes
 */
object TheMovieDestinationsArgs {
 ...
 */
class TheMovieNavigationActions(private val navController: NavHostController) {
    ...
    fun navigateToStatistics() {
        navController.navigate(TheMovieDestinations.STATISTICS_ROUTE) {

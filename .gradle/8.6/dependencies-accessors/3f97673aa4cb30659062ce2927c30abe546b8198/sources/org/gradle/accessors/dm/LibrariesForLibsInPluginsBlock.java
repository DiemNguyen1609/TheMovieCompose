...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>r8</b> with <b>com.android.tools:r8</b> coordinates and
     * with version reference <b>r8</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getR8() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("r8");
    }
    ...
    public static class DetektLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>detektFormatting</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        /**
         * Group of libraries at <b>detekt.gradle</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
    ...
    public static class DetektGradleLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>plugin</b> with <b>io.gitlab.arturbosch.detekt:detekt-gradle-plugin</b> coordinates and
         * with version reference <b>detektFormatting</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
    ...
    public static class Okhttp3LibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        private final Okhttp3LogLibraryAccessors laccForOkhttp3LogLibraryAccessors = new Okhttp3LogLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>okhttp3.log</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Okhttp3LogLibraryAccessors getLog() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForOkhttp3LogLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class Okhttp3LogLibraryAccessors extends SubDependencyFactory {

        public Okhttp3LogLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>intercepter</b> with <b>com.squareup.okhttp3:logging-interceptor</b> coordinates and
         * with version reference <b>okhttp</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getIntercepter() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("okhttp3.log.intercepter");
        }
    ...
    public static class Retrofit2LibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        private final Retrofit2ConvertLibraryAccessors laccForRetrofit2ConvertLibraryAccessors = new Retrofit2ConvertLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>retrofit2.convert</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Retrofit2ConvertLibraryAccessors getConvert() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForRetrofit2ConvertLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class Retrofit2ConvertLibraryAccessors extends SubDependencyFactory {

        public Retrofit2ConvertLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getGson() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("retrofit2.convert.gson");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidDesugarJdkLibs</b> with value <b>2.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidxActivity</b> with value <b>1.9.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidxComposeCompiler</b> with value <b>1.5.15</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>annotation</b> with value <b>1.8.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>detektFormatting</b> with value <b>1.22.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getDetektFormatting() { return getVersion("detektFormatting"); }
        ...
        /**
         * Version alias <b>protobufPlugin</b> with value <b>0.8.19</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>r8</b> with value <b>8.5.35</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getR8() { return getVersion("r8"); }
        ...
        /**
         * Version alias <b>truth</b> with value <b>1.1.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
